...
def main_document():
    ...
    st.sidebar.markdown(""" <div class="blue-box">  <h3>Welcome to Brainwave AI!</h3>
            ...
            <ol>
                ...
                <li>Once processed, you can enter any question related to the content of the uploaded documents, and the AI will provide an accurate response.\n\n"
        "Please follow the steps to get started.).</li>
            </ol>
        </div>
